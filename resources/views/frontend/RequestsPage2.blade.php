                ...
                <div class="row" style="margin: auto;">
                    ...
                    <div class="col-lg-8 col-md-8 search" style="padding-bottom:35px;">
                        <div class="row searchbar">
                            <form action="{{route('whatareyoulookingfor')}}" method="post" class="form-f1 d-flex">
                                @csrf
                                <input name="name" class="form-control" type="search" placeholder="What are you looking for?" aria-label="Search" style="background-color: rgb(247, 244, 244);border: 0px;box-shadow: none;outline: none;">
                            ...
                            <div class="col col2">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                        ...
                                        <li value="{{$cate->name}}"><a class="dropdown-item" href='requests-category{{$cate->name}}'>{{$cate->name}}</a></li>
                                        @endforeach
                            ...
                            <div class="col col3">
                                <div class="dropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="#">Action</a></li>
                                        ...
                                        <li value="{{$bar->position}}"><a class="dropdown-item"
                                        href='requests-location{{$bar->position}}'>
                                    ...
                                    <div class="col pb-5 leftsidebar">
                                        <div class="py-3 cardheight cardleft" style="background-color: white; border-radius: 10px;box-shadow: 10px 10px 100px 1px #ffe8ef; padding-left: 10px; margin: auto;">
                                            <div class="row">
                                                ...
                                                <!-- Heart Image -->
                                                    <a href="{{route('favouriterequest',[ 'user_id' =>  $r->auth_id  , 'requestid' =>  $r->id ] )}}" role="button"><img class="responses-heart1" src="{{asset('theme/icons/ic_favorite_border_24px.png')}}"></a>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="" style="padding-left: 10px;">
                                                    <a href="{{route('view-detail',['id'=>$r->id])}}" style="text-decoration:none;color: black;">
                                                        ...
                                                        <p style="display: inline;font-size: 14px;color: #F9326D;margin-left: 10px;">Only Professional</p>
                                                        @endif
                                                        @if($r->phone_number=='Show Phone Number')
                                                        <p style="display: inline;font-size: 14px;color: #F9326D;margin-left: 10px;">Show Phone Number</p>
                                                        @endif
                                                    </a>
                                                ...
                                                <div class="carousel-item active">
                                                    <div class="col">
                                                        <div class="card text-white" style="width: 10rem;border-radius: 10px;margin: auto;">
                                                            <img src="../../uploads/{{$s->file}}" style="width: 10rem;height: 10rem;">
                                                            <div class="card-img-overlay" style="padding: 0;">
                                                                <div class="RealizeImg-text text-center">
                                                                    <p style="padding-top: 0.5rem;font-size: 14px;">{{$s->filename}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row" style="padding-bottom: 10%;">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination" style="justify-content: space-between;width: 22rem;margin: auto;">
                                                <li class="page-item"><a class="page-link" id="pagination-num" href="{{route('requests2',[ 'limtit1' => '0'  , 'limtit2' => '30'  ])}}">1</a></li>
                                                <li class="page-item"><a class="page-link" id="pagination-num" href="{{route('requests2',[ 'limtit1' => '30'  , 'limtit2' => '30'  ])}}">2</a></li>
                                                <li class="page-item"><a class="page-link" id="pagination-num" href="{{route('requests2',[ 'limtit1' => '60'  , 'limtit2' => '30'  ])}}">3</a></li>
                                                <li class="page-item"><a class="page-link" id="pagination-num" href="{{route('requests2',[ 'limtit1' => '90'  , 'limtit2' => '30'  ])}}">4</a></li>
                                                <li class="page-item"><a class="page-link" id="pagination-num" href="{{route('requests2',[ 'limtit1' => '120'  , 'limtit2' => '30'  ])}}">5</a></li>
