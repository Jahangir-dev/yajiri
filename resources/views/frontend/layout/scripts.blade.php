            ...
            $('.continueWithPhone').click(function(){
                ...
                if($('.registrationPhoneNumber').val()!=''){
                    ...
                    $.ajax({
                        ...
                        data:{_token: "{{ csrf_token() }}",phone_number:phone_number,pre_phone_number:pre_phone_number
                        },
                        success: function( msg ) {
                ...
                $('.email_Number_code').each(function(){
                 ...
                 $.ajax({
                        ...
                        data:{_token: "{{ csrf_token() }}",userEmail:userEmail,code,code
                        },
                        success: function( msg ) {
                            if(msg==1){
                                $('.registrationPhoneNumberAlert').show();                                
...
/*                    for testing*/
                ...
                $('.phone_Number_code').each(function(){
                 ...
                 $.ajax({
                        ...
                        data:{_token: "{{ csrf_token() }}",phone_number:phone_number,code,code
                        },
                        success: function( msg ) {
                            if(msg==1){
                                $('#notmatchedsendedphoneNumberAlert').hide();
...
/*              
    ...
    <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
           <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBikMgCY_d1NwtVzeM4mIviqZBBDrAFEko&callback=initMap&libraries=places&v=weekly&channel=2"
      async
    ></script>
...
$('.phone_Number_code').keyup(function(e){if(e.keyCode == 8) $(this).prev('.phone_Number_code').focus(); })  
