...
@section('sServiceProviders','active_nav')

<link rel="stylesheet" href="{{asset('theme/css/ServiceProvidersStyle.css')}}">
...
<body style="zoom:90%">
    ...
    <section class="text-center" style="padding-top: 1.5rem!important;">
        <div class="row" style="margin:0px">
            ...
            <div class="col-lg-12">
                <div class="background-image1 text-center backgroundimage">
                    <p class="showcase-text1" style="color:white;">Hundreds of service providers near you to do your
                        help</p>
                    <p class="showcase-text2" style="font-size: 22; font-weight:500;color: white;">Find a service
                        provider near who can help you</p>
            ...
            <div class="col-lg-7 col-md-12 " style="margin: auto;">
                <div class="row searchbar">
                    <form action="" method="get"  class="form-f1 d-flex"
                        style="border: 2px solid #65e3f5;">
                        <input class="form-control" name="search" type="search"
                            placeholder="What are you looking for?" value="{{\Request::has('search')?\Request::get('search'):''}}" aria-label="Search"
                            style="background-color: rgb(247, 244, 244);     border: 0px solid">
                        <button class="form-button1 btn" type="submit"><img class="form-img1"
                                src="{{asset('theme/icons/Group 2409.png')}}" alt=""></button>
                    </form>
                </div>
                    ...
                    <div class="col-lg-6 col2" style="padding-bottom:5px;">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                                ...
                                <li value="{{$bar->address}}"><a class="dropdown-item"
                                        href="{{route('serviceproviderboards',$bar->id,[ 'id' => $bar->address])}}">{{$bar->address}}</a>
                                </li>
    ...
    <section>
        <div class="col" id="MyFavouritesID">
            ...
            <div class="row" style="margin:0px;">
                ...
                <div class="col-lg-3 cardtop">
                    <!-- <div class="py-5 categoryicard" style="
                        ...
                        <div style="padding-top: 1rem;display: none;" class="subcategory_list">
                ...
                <div class="col-lg-7 sidebartop">
                    ...
                    <div class="col-xxl-7 col-xl-12" style="    width: auto;%;" id="CategoriesColShow">

                        <div class="col pb-5 leftsidebar" style="margin: auto;">
                            <div class="py-3"
                                style="background-color: white; border-radius: 10px;box-shadow: 1px 1px 100px 1px #eafaff; padding-left: 10px; margin: auto;">
                                <div class="row">
                                    <div class="col">
                                        <p class="responses-date1 text-start pt-2" style="color:#5fbcd8">
                                            {{$u->created_at->diffForHumans()}}</p>
                                    </div>
                                    <div class="col pt-2 text-end" style="padding-right: 30px;">
                                        <a href="{{Auth::user()!=NULL?route('serviceproviderfav', [ 'id' =>  $u->id ]):'#'}}">
                                               @if($u->service_fvrt)
                                                <img class="responses-heart1"
                                                    src="{{asset('theme/icons/ic_favorite_24px.png')}}">
                                                @else
                                                <img class="responses-heart1"
                                                    src="{{asset('theme/icons/ic_favorite_border_-1.png')}}">
                                                @endif  
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-3 col-sm-6" style="margin: auto;position: relative;">
                                                ...
                                                <a href="{{Auth::user()!=NULL?route('profileuser', [ 'id' =>  $u->id]):'#'}}">
                                                        ...
                                                        @if($u->image)
                                                            ...
                                                            <img
                                                                    class="requestFaceImg1" src="{{asset($u->image)}}">
                                                            @else
                                                                                                                <img
                                                        ...
                                                        <p class="mobileparticular">Particular</p>
                                                    </a>
                                                    <img src="{{asset('theme/icons/Group 2412.png')}}"
                                                        class="requestFaceImgTICK">
                                            </div>
                                            <div class="col-9 col-sm-6 text-start starside" style="margin: auto;">
                                                <div class="row">
                                                <a <?php if(!Auth::check()) echo 'data-bs-toggle="modal" role="button" href="#LoginRegisterModal8"'; ?> href="{{Auth::user()!=NULL?route('profileuser', [ 'id' =>  $u->id]):'#'}}" style="text-decoration:none">
                                                            ...
                                                            <p class="Responses-Name1 text-start haris"
                                                                style="margin-bottom: 0.5rem;">
                                                                <b style="color: black;">{{$u->name}}</b> </p>
                                                        </a>
                                                </div>
                                                <div class="row">
                                                    <div class="col d-flex">
                                                        <img class="responses-star1 harisstar"
                                    ...
                                    <div class="col-sm-7 col-12" style="padding-left: 20px;">
                                        @if($u->aboutme)
                                        <p id="request-textID2" class="text-start pt-1 show-less-div-4">
                                            {{$u->aboutme}}</p>
                                ...
                                <div id="responsesID1" class="col-12" style="padding-left: 10px;">
                                    <img src="{{asset('theme/icons/ic_label_24px.png')}}" class="categoryicon"
                                        style="width: 22px;height: 17px;padding-top: 2px;">
                                    <p class="responses-buttons1234 text-start categorytext">Categories</p>
                                </div>
                                <hr id="LineID1" class="hrtop" style="width: 90%;margin: auto;height: 2px;">
                                <div class="row pt-3" style="padding-left: 10px;">
                                    <div class="col-md-3 col-sm-4 col-6 d-flex pt-1">
                                        <img src="{{asset('theme/icons/ic_place_-1.png')}}" class="lebardoicon"
                                            style="width: 15px;height: 22px;">
                                        <p class="responses-buttons1234 text-start lebardotext ">{{$u->address}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-12 pt-1" id="responsesID2" >
                                        <img src="{{asset('theme/icons/ic_label_24px.png')}}" style="    width: 21px;
                                            height: 15px;
                                    ...
                                    <div class="col-md-2 col-sm-12 col-12 pb-2 ">
                                        ...
                                        <div class="modal fade" id="staticBackdrop{{$u->id}}" data-bs-keyboard="false"
                                            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="col text-center mb-3">
                                                            <img src="{{asset('theme/icons/bluecontact.png')}}"
                                                                style="width: 2.3rem;">
                                                        </div>
                                                        <p class="MBText1"> </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col text-center">
                                                                <a href="{{route('bluechat', [ 'id' => $u->id ])}}"
                                                                    class="SendMessageButton">Send Message</a>
                                                            </div>
                                                            <div class="col text-center">
                                                                <a href="" class="CallButton" data-bs-toggle="modal"
                        ...
                        <div class="row py-4 bottomslider2">
                            <p class="Realize-text1 realizeproject" style="font-weight: bold;margin-bottom: 1px;">
                                Realize Your Projects!
                            </p>
                            <p class="Realize-text1 realizetext2">Find at a glance all the services dedicated to your
                                current needs!</p>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            @if($i++==1 && $i<=$number ) <div class="col-lg-4">
                                                <div class="card text-white"
                                                    style="width: 10rem;border-radius: 10px;margin: auto;">
                                                    <img src="{{asset('uploads/'.$slide->file)}}"
                        ...
                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselMobile"
                            data-bs-slide="prev">
                            <img src="{{asset('theme/icons/Group 2158.png')}}" class="imageicon-right">
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carouselMobile"
                            data-bs-slide="next">
                            <img src="{{asset('theme/icons/Group 2157.png')}}" class="imageicon">
                            <span class="visually-hidden">Next</span>
                        </button>
                    </div>
                </div>
            ...
            <!--Recent Requests-->
        <div class="row pagiantionserviceprovider">
                
              {{$users->render("pagination::serviceProviderPagination")}}   
        ...
        <section class="pb-5 text-center">
            <div class="text-light" style="margin: auto;">
    ...
    <section>
        <div class="modal fade" id="mobilechat" data-bs-keyboard="false" tabindex="-1"
    ...
    <!--Modal 2 Report-->
    <section>
        <div class="modal fade modal-backdrop.show " id="staticBackdropReport" data-bs-keyboard="false" tabindex="-1"
    ...
    top: 12px;">Continue</p>
                    ...
                    <div class="LRMmobileB row">
                        <div class="col-3">
                            <img src="{{asset('theme/icons/ic_mail_outline_24pxblack.png')}}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="LRMmobileB LRMmobileB1 row">
                        <div class="col-3">
                            <img src="{{asset('theme/icons/ic_phonelink_lock_24pxBlack.png')}}">
                        </div>
                        <div class="col-9">
                    ...
                    <div class="MHmodel3 modal-header row">
                        <div class="col-3 col-sm-3">
                            <button type="button" data-bs-dismiss="modal" aria-label="Close"
                                ...
                                <img class="model-img1"
                                    src="{{asset('theme/icons/ic_keyboard_arrow_right_24Blackpx.png')}}">
                            </button>
                        </div>
    ...
    <section>
                ...
                <div class="modal-content">
                    ...
                    <div class="Modal4Body modal-bodylogin">
                        ...
                        <div class="input-group mb-2">
                            <select class="Modal4select1 form-select form-select-sm purpose"
        ...
        font-size: 12px;
        border-radius: 10px 10px 0 0;" class="Modal4input1 form-control private" placeholder="First Name"
        ...
        background-size: 12px 12px;
        background-position: right 2rem center;
        font-size: 12px;border-radius: 0 0 10px 10px;" class="Modal4input2 form-control private"
        ...
        background-position: right 2rem center;font-size: 12px;" class=" form-control professional"
                                placeholder="Company Name" aria-label="Company Name" aria-describedby="basic-addon1">
                        </div>
                        ...
                        <div class="input-group mb-2">
                            <input type="text" style="display:none;border-radius: 10px 10px 0 0;font-size: 12px;"
                                class="Modal4input4 form-control professional" placeholder="SIRET Number"
                        ...
                        <div class="">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="FieldsetCheck">
                                    <p class="Modal4Form-Categoryt1" style="padding-top: 0.2rem;">I accept <a
                                            style="color: #F82268;text-decoration: none;" href="">general terms and
                                            conditions.</a> </p>
                                </label>
                            </div>
                        </div>
                        <div class="pt-1 mb-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="FieldsetCheck"
                                    style="height: 1.2rem;">
                                <label class="form-check-label" for="FieldsetCheck">
                                    <p class="Modal4Form-Categoryt1" style="padding-top: 0.2rem;">Receive information
                                        from our partners.</p>
                                </label>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="Modal5Body modal-body">
                        ...
                        <p class="Modal5Text2">In publishing and graphic design, Lorem ipsum is a placeholder text
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:20px;">
                ...
                <div class="Modal6Body">
                    ...
                    <p class="Modal6Text2">In publishing and graphic design, Lorem ipsum is a placeholder text commonly
    ...
    height: 3rem;" class="form-control" placeholder="Example@email.com" aria-label="Example@email.com"
                            aria-describedby="basic-addon1">
                    </div>
                    <p class="Modal6Text2 mb-5">In publishing and graphic design, Lorem ipsum is a placeholder text
                        commonly used to demonstrate the visual form of a document</p>
    ...
    <div class="modal fade" id="LoginRegisterModal8" tabindex="-1" aria-labelledby="LoginRegisterModal8Label"
                    ...
                    <div class="row">
                        <div class="">
                            <input type="text" class="form-control" id="exampleInputPassword1"
                                ...
                                style="height: 3rem;border-radius: 10px 10px 0 0;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3">
                            <input type="password" class="form-control" id="exampleInputPassword3"
                                placeholder="Password" style="height: 3rem;border-radius: 0 0 10px 10px;">
                            <div class="input-group-addon">
                                <a href=""><img class="passwordEye"
                                        src="{{asset('theme/icons/ic_visibility_off_24px.png')}}"
        ...
        top: 10px;">Continue</p>
                ...
                <div class="modal-footer" style="margin: auto;border: none;">
                    <div class="row">
                        <img src="{{asset('theme/icons/yajari-removebg-preview.png')}}" style="    width: 8rem;
    margin: 0px;">
                    </div>
                </div>
            </div>
