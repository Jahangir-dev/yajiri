                ...
                <div class="modal-content">
                    <div class="MHmodel3 modal-header row">
                        ...
                        <div class="col-9 col-sm-9">
                            <p class="modal-title text-start" id="LoginRegisterModal3Label">Confirm Telephone Number</p>
                        </div>
                    </div>
                    ...
                    <div class="row LRM1Button" style="width:30%;">
                            ...
                            <a  role="button" style="text-decoration:none" id="phone_Number_code_verify">
