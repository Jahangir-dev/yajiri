...
<body style="zoom:90%;" class="bodyheight">
                ...
                <div class="col-12 col-md-9 col-sm-12">
                    <div class="d-flex flex-wrap" style="justify-content: space-between;">
                        <div class="mrgin_leftt">
                            <div class="row" style="margin-top: 1rem;">
                                <div class="col d-flex">
                                    <p class="ProfileText1">{{ $usersdetail->first_name}} {{ $usersdetail->last_name}}
                                    </p>
                                    <p class="mt-2" style="margin-left: 1rem;"><span class="Privatetext"></span></p>
                                </div>
                            </div>
                        ...
                        <div class="d-flex mt-3 joined">
                            ...
                            <p class="ProfileText2">{{ $usersdetail->created_at}}</p>
                        </div>
  ...
  {{ $usersdetail->aboutme}}
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form method="POST"
                                        action="{{route('userprofileservice')}}">
                                        @csrf
                                    </h5>
            ...
            <div class="col-12 col-md-4 col-sm-12 maptop">
                ...
                <iframe src="https://goo.gl/maps/zpF5FeszrAn7vmsg8" width="347" ; height="340" ;
                    ...
                    <div class="AboutMeRow2 row" style="margin-top: 1rem;">
                        ...
                        <div class="row">
                            <div class="col piccenter" style="width: 10rem;">
                                <img src="{{ $usersdetail->photogallery1}}" class="card-img-top imagewidth">

                            </div>
                            <div class="col" style="width: 10rem;">
                                <img src="{{ $usersdetail->photogallery2}}" class="card-img-top imagewidth">

                            </div>

                            <div class="col" style="width: 10rem;">
                                <div class="upload-Picture">
                                    <img src="{{asset('theme/icons/ic_add_a_photo_24px.png')}}"
                                        class=" iconsettingprofile">
                                </div>
                ...
                <div class="col-12 col-md-4 col-sm-12 sendrequest">
                    ...
                    <div class="ReviewContainer" style="width:95%;     position: relative;
                        ...
                        <div class="row" style="position: relative;top: 15px;">
                            <a href="LeaveReview.html" class=" nav-item nav-link previews"><img
