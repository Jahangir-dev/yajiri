    ...
    <section class="LeaveReviewSection">
        ...
        <form action="{{route('saveReport')}}" method="post">
            ...
            <div class="row">
                ...
                <p class="ReviewText1">Leave a reason to Report this Profile</p>
            </div>
            <div class="row">
                <input type="hidden" name="user_id" value="{{$id}}">
                <textarea class="form-control" name="reason" aria-label="With textarea"  placeholder="Describe your reason to report" rows="5"></textarea>
            </div>
            <div class="row">
                <button  type="submit" class="PostReviewButton">Report</button>
            </div>
            </form>
        </div>
